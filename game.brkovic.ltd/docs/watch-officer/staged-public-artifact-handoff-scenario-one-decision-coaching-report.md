...
Engine подготовил handoff manifest для QA-approved Godot Web export `Scenario 1 Decision Coaching Pack`.
...
- TASK-0084 report status: `passed`
- TASK-0085 QA status: `approved-for-staged-public-candidate`
- Game Director decision: `Approved for staged public candidate update`

This is the TASK-0084 / TASK-0085 approved build for the `Scenario 1 Decision Coaching Pack`.
...
- Engine did not touch production files.
