...
| QA | Maritime QA / Validation | Staged public selector smoke | TASK-0119 approved |
...
| Platform Deploy | Platform Deployment Officer | Scenario selector production deploy | TASK-0120 assigned |
