...
| UI/HUD | UI/UX HUD Designer | Scenario selector UX spec | TASK-0112 passed |
| Engine | Engine / Godot Architect | Local Web export with scenario selector | TASK-0116 passed |
| QA | Maritime QA / Validation | Production selector smoke | TASK-0121 approved |
